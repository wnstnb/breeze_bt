...
api_url = os.getenv("FIRSTRATEDATA_INCR_API")
...
if response.status_code == 200:
    ...
    with zipfile.ZipFile(zip_content, "r") as zip_ref:
        ...
        for file_name in tqdm(zip_ref.namelist()):
            if file_name in ['SPX_month_30min.txt','VIX_month_30min.txt','VVIX_month_30min.txt','NDX_month_30min.txt','RUT_month_30min.txt']:
                try:
